...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 15:09:43 2019
    ...
    while True:
        ...
        if done:
            ...
            if(len(q_values.keys()) > 0):
                Q_s_prime_a_prime = np.mean(q_values.keys()) #calculating expected value of q_values instead of max which is in q-learning
            else:
                Q_s_prime_a_prime = 0
